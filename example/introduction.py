...
Descriptions:
    ...
    NOTE: 
    Assumes your base dimensions are SI metric for (notation)
"""
...
axial_length = parameters.stator.pole.axial_length
outer_radius = parameters.stator.pole.outer_radius
